...
disk_space = 70000000
current_free_space = disk_space - starting_node.calculate_size()
dir_sizes = starting_node.calculate_dir_sizes()
deletion_candidates = []
for size in dir_sizes:
  potential_free_space = current_free_space + size[1]
  if potential_free_space >= 30000000:
    deletion_candidates.append(size[1])
