    ...
    if lowest_cost_node_value == 'E':
      ...
      for child in children:
        ...
        for existing_closed_list_node in closed_list:
          ...
          child_node.heuristic = ((child[0] - end_node.coordinates[0]) ** 2) + ((child[1] - end_node.coordinates[1]) ** 2)
          child_node.total_node_cost = child_node.start_distance + child_node.heuristic
